...
def get_best_guess_or_none(serialized_image, bg_image, additional_iconic_classes=None):
    """
    This is the only function that should be called externally to this module.
    Takes a serialized image, and a dict mapping item name --> descriptors.
    ...
    img_bytes = base64.b64decode(serialized_image.encode('utf-8'))
    # convert bytes data to PIL Image object
    import pdb; pdb.set_trace()
    cv.imdecode(img_bytes)
